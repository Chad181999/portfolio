...
function Home() {
  return (
    <Box bgImage={'/common-bg.svg'} bgRepeat='no-repeat' bgSize='cover' w='100%' h='100%' position='relative' id='monggo'>
        <Box position='absolute' w='100%' h='100%' bgGradient='linear(to-r, rgba(245,245,245,.8), rgba(245,245,245,.8))'></Box>
        <Flex h={{base: 'auto', lg: '100vh'}} justifyContent='center' alignItems='center' position='relative' z-zIndex='1'>
            <Box>
                ...
                <Box>
                    <Heading fontSize='60px' color='#111111' fontWeight='900' textAlign='center'>Hey, I'm Richard T. Dela Cruz Jr</Heading>
                </Box>
